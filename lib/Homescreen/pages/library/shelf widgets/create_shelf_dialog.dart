...
class CreateShelfDialog extends ConsumerStatefulWidget {
  const CreateShelfDialog({super.key});

  @override
  ConsumerState<CreateShelfDialog> createState() => _CreateShelfDialogState();
}

class _CreateShelfDialogState extends ConsumerState<CreateShelfDialog> {
  final TextEditingController _nameController = TextEditingController();
  final TextEditingController _descriptionController = TextEditingController();
  Color _selectedColor = const Color(0xFF2D5A3D); // Default to first icon color
  ...
  Future<void> _createShelf() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Failed to create shelf: $e'),
          backgroundColor: Colors.red,
        ),
      );
    }
